  ...
  useEffect(() => {
    ...
    const getHTML = () => {
      if (props.changedWidth === "monitor") {
        ...
        const classBurger = isMenuOpen
          ? "header__burger active-burger"
          : "header__burger";
        const classMenu = isMenuOpen
          ? "header__menu-form header__menu-form_active"
          : "header__menu-form";
        setUserBox(
          <>
            <div
            ...
            <div className={classMenu}>
              <div className="header__links-form">
                <Link
                  ...
                  className={`header__link ${
                    linkActive === "main" ? "header__link_active" : ""
                  }`}
                >
                  Главная
                </Link>
                <Link
                  to="/movies"
                  className={`header__link ${
                    linkActive === "movie" ? "header__link_active" : ""
                  }`}
                >
                  Фильмы
                </Link>
                <Link
                  to="/saved-movies"
                  className={`header__link ${
                    linkActive === "saved" ? "header__link_active" : ""
                  }`}
                >
                  Сохранённые фильмы
                </Link>
              ...
              <div className="header__user-form">
                <Link
                  to="/profile"
                  className={`header__link-akk ${
                    linkActive === "akk" ? "header__link_active" : ""
                  }`}
                >
                  Аккаунт
                </Link>
